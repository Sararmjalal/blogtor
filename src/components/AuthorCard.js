...
const AuthorCard = ({author}) => {
    return(
        ...
        <div className="mt-4 m-2 p-4 rounded-2xl shadow-md	shadow-blue-700/10">
          <div className="flex">          
              <img className="w-24 h-24 rounded-full mr-4 shadow-md	shadow-blue-700/10 aspect-square object-cover" src={`${DOMAIN}/${author.avatar}`} onError={(e) => e.target.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkqGG1REKqgE2MNG8gLCJh5BEujRypjNSJsg&usqp=CAU"}></img>
